...
blocksize = 32;
for di = 1:73
    i = imread(['D:\vignesh\Data_Analysis\Miku Data\to give vignesh\0.2ug_mL chalcone 1\thresh',num2str(di),'.tif']);  
    sz = size(i);
...
Y = mat2vertcol(yy); 
Z = [X,Y];
path = fullfile(['D:\vignesh\Data_Analysis\Miku Data\to give vignesh\0.2ug_mL chalcone 1\Window_Area_',num2str(di),'.xlsx']);
